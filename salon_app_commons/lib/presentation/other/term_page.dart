...
class TermPage extends StatelessWidget {
  ...
  static const text = '''
<p>この利用規約（以下，「本規約」といいます。）は，株式会社KBOY（以下，「当社」といいます。）が「Flutter大学」（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
...
<ol><li>ユーザーは，本サービスの有料部分の対価として，本ウェブサイトに表示する利用料金を，Stripeの定期決済機能により支払うものとします。</li>
<li>ユーザーが利用料金の支払を遅滞した場合、特別な事情がない場合は、当社から強制的に退会の措置をとる事ができるものとする。</li>
</ol>
...
<ol><li>当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。
...
<p>ユーザーは，サロン専用アプリでの退会手続きまたはSlackのDMにてKBOY(藤川慶)に直接申告することによって本サービスから退会できるものとします。</p>
